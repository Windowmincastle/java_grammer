...
public class BankMain {
    ...
    public static void main(String[] args) {
        ...
        List<C02ClassBasic.실습패키지필기.BankAccount> bankAccounts = new ArrayList<>();
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                bankAccounts.add( new C02ClassBasic.실습패키지필기.BankAccount(want) ); //계좌번호 동적 생성
                ...
                C02ClassBasic.실습패키지필기.BankAccount temp = bankAccounts.get(idx);
