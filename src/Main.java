...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int lo = 1;		// 최소 거리가 가질 수 있는 최솟값 한칸 한칸 한칸을 의미한다.
        ...
        while(lo < hi) {	// Upper Bound 형식
             ...
             * "공유기를 설치할수 있는 집간의 최소거리"를 좁혀야 하기 때문에 hi 를 줄인다.
             */
            if(canInstall(mid) < M) {
                hi = mid;
            }
                 ...
                 * 거리를 벌리면서 "공유기를 설치할수 있는 집간의 최소거리"가 가질 수 있는 최대 거리를
                 * 찾아낸다.
                 */
                lo = mid + 1;
            }
